...
class Automata:
    ...
    def agregar_final(self, estado: int):
...
class AFN(Automata):
    ...
    def movereps(self, estado: int):
        """Retorna los elementos alcanzados por un simbolo empezando por un estado si existe la transicion"""
        res = []
    ...
    # def mover(self, estados: list, simbolo: str):
